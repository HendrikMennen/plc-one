  ...
  return (
    <main className='px-3 overflow-hidden'>
      ...
      <div className='m-auto mt-10 text-xl'>
        ...
        <span className='text-xl'>Datenschutzerklärung</span> <br/>
...
Leon Beier lbeier@protop-solutions.com Hornscher Weg 23 32657 Lemgo Deutschland
...
<div className='mt-10 text-sm text-justify text-stone-100'>
        ...
        <span className='text-xl'>Privacy Policy</span> <br/>
...
Leon Beier lbeier@protop-solutions.com Hornscher Weg 23 32657 Lemgo Germany
